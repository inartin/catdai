...
- Shared footer. Its `Noutăți` link routes to `/noutati`; Telegram remains only as the social icon link. Footer also displays the required Paynet, Mastercard, and blue Visa payment-system logos from `public/brands`.
