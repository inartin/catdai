...
- Shared footer. Its `Noutăți` link routes to `/noutati`; footer legal links include Terms, Privacy, and Refund; Telegram remains only as the social icon link. Footer also displays the required Paynet, Mastercard, and blue Visa payment-system logos from `public/brands`.
