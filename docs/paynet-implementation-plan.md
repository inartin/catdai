...
Current gap:
- `terms` and `privacy` exist, but production legal company details, legal address, support hours, and digital-service refund/cancellation rules still need final business text.
